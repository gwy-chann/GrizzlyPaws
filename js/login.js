...
signupBtn.addEventListener('click', (e) => {
    ...
    if (!mobile) {
        ...
        document.getElementById('signup-mobile-error').textContent = 'Please enter a valid 10-11 digit mobile number';
        isValid = false;
    }
    ...
    if (!securityQ1) {
        document.getElementById('security-question-1-error').textContent = 'Please select a security question';
        isValid = false;
    }
    
    if (!securityA1) {
        document.getElementById('security-answer-1-signup-error').textContent = 'Answer is required';
        isValid = false;
    }
    
    if (!securityQ2) {
        document.getElementById('security-question-2-error').textContent = 'Please select a security question';
        isValid = false;
    }
    
    if (!securityA2) {
        document.getElementById('security-answer-2-signup-error').textContent = 'Answer is required';
        isValid = false;
    }
    
    if (securityQ1 && securityQ2 && securityQ1 === securityQ2) {
        document.getElementById('security-question-2-error').textContent = 'Please select different security questions';
        isValid = false;
    }
    ...
    if (isValid) {
        users[email] = {
            ...
            profilePhoto: '', // No photo by default
            securityQuestions: {
                question1: securityQ1,
                answer1: securityA1.toLowerCase(),
                question2: securityQ2,
                answer2: securityA2.toLowerCase()
            }
        };
