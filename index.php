  ...
  <body>
    ...
    <main class="container">
      <div class="main-content">
        <div class="hero-container">
          <div class="hero-image">
            <img
              src="images/HeroImages/grizzly_hero.png"
              alt="Hero Image"
              class="active"
            />
            <img src="images/HeroImages/grizzly_hero1.png" alt="Hero Image" />
          </div>
        ...
        <div class="discount-container">
          <a href="#pet-categories-heading">
            <img
              src="images/HeroImages/discount_hero.png"
        ...
        <div class="pet-categories">
          ...
          >
            <div class="pet-image-container small_pet-bg">
              <img
                src="images/CategoryImages/small_pet_cat.png"
                alt="Small Pet"
                class="pet-image"
                aria-hidden="true"
              />
          ...
          >
            <div class="pet-image-container bird-bg">
              <img
                src="images/CategoryImages/bird_cat.png"
                alt="Feathered"
                class="pet-image"
                aria-hidden="true"
              />
          ...
          >
            <div class="pet-image-container fish-bg">
              <img
                src="images/CategoryImages/aquatic_cat.png"
                alt="Aquatic"
                class="pet-image"
                aria-hidden="true"
              />
        ...
        <div class="offers-grid">
          ...
          <div class="offer-card">
            ...
            <div class="offer-image">
              <img
                src="images/SpecialOfferImages/special_offer_1.png"
          ...
          <div class="offer-card">
            ...
            <div class="offer-image">
              <img
                src="images/SpecialOfferImages/special_offer_2.png"
          ...
          <div class="offer-card">
            ...
            <div class="offer-image">
              <img
                src="images/SpecialOfferImages/special_offer_3.png"
      ...
      <div class="product-banner">
        <img src="images/productsBanner.png" alt="Product Banner">
      </div>
    ...
    <div class="faq-accordion">
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer">
          <p>Yes! Grizzly Paws is completely free to browse and shop. There are no membership fees or hidden charges. You only pay for the products you purchase and applicable shipping fees. We also offer free shipping for orders over ₱1,500!</p>
        </div>
      </div>
